    ...
    <div className='w-full bg-white py-16 px-4'>
      <div className='max-w-[1240px] mx-auto flex flex-col-reverse gap-8 md:flex-row md:items-center'>
        <div className='md:w-1/2'>
          <h1 className='md:text-4xl sm:text-3xl text-2xl text-center md:text-justify font-bold py-2 font-font1 text-primary'>
            Our Vision
          </h1>
          <p className='text-lg text-center md:text-justify py-2 font-bold font-font2'>
